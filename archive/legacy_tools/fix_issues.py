...
if idx != -1:
    ...
    try:
        ...
        print("\\n[!] SÝSTEM DURDURULDU (Kullanýcý Ýptali). OTONOM BÜYÜK SENTEZ RAPORU OLUÞTURULUYOR...\\n")
        ...
        try:
            ...
            print(f"[OK] BÜYÜK RAPOR '{rapor_dosyasi}' DOSYASINA KAYDEDÝLDÝ!")
