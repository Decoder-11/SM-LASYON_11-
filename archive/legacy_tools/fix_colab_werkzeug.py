...
# I will replace the end block again to handle both KeyboardInterrupt AND normal return from start_dashboard()
marker = 'try:\n        print("\\n[!] Levhi-Mahfuz Dashboard Sunucusu Baslatiliyor'
